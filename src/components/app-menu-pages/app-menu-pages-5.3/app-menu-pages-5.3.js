...
export default class AppMenuPages53 extends Component {
        ...
        <>
            ...
            <div class="app__page-header_top">
                ...
                <div class="app__page-header_top-container">
                    ...
                    <Link to="/dlxevo/5.2" ><ChevronLeftIcon fontSize="large"/></Link>
                    </div>
                    <div class="app__page-header_top-container-title">
                        <h2 class='work'>5.3 Расчет аварийного освещения</h2>
                    </div>
                    <div class="app__page-header_top-container-right">
                    <Link to="/dlxevo/6" ><ChevronRightIcon fontSize="large" /></Link>
                ...
                <div className="app__page-title_video">
                    ...
                    src="https://www.youtube.com/embed/A-fP_nKh5bA" title="YouTube video player" 
                ...
                <div class="app__page-title_files">
                   ...
                   <div class="app__page-title_files-wrap-icon"><a class="app__page-title_files-wrap-icon-a" href="https://disk.yandex.ru/d/Z25iQq4AGHPgzg" target="_blank"><CloudDownloadIcon/></a></div>

<p className="app__page-title_files-wrap-zip"><a href="https://disk.yandex.ru/d/Z25iQq4AGHPgzg" target="_blank">Урок-5.3.zip</a></p>
  </div>
                ...
                <div class="app__page-title_files-task">
                    ...
                    <ul className="app__page-title_files-text">
                                ...
                                <li>Сделать аварийное освещение для 2 этажа.</li>
