...
export default class AppMenuPages52 extends Component {
        ...
        <>
            ...
            <div class="app__page-header_top">
                ...
                <div className="app__page-title_video">
                    ...
                    src="https://www.youtube.com/embed/hr-s-HmBYMo" title="YouTube video player" 
                ...
                <div class="app__page-title_files">
                   ...
                   <div class="app__page-title_files-wrap-icon"><a class="app__page-title_files-wrap-icon-a" href="https://disk.yandex.ru/d/LBGXMQVAnau5CQ" target="_blank"><CloudDownloadIcon/></a></div>

<p className="app__page-title_files-wrap-zip"><a href="https://disk.yandex.ru/d/LBGXMQVAnau5CQ" target="_blank">Урок-5.2.zip</a></p>
  </div>
                ...
                <div class="app__page-title_files-task">
                    ...
                    <ul className="app__page-title_files-text">
                                ...
                                <li>Осветить все помещения, включая 2 этаж.</li>
