...
export default class AppMenuPages6 extends Component {
        ...
        <>
            ...
            <div class="app__page-header_top">
                ...
                <div class="app__page-header_top-container">
                    ...
                    <Link to="/dlxevo/5.3" ><ChevronLeftIcon fontSize="large"/></Link>
                    </div>
                    <div class="app__page-header_top-container-title">
                        <h2 class='work'>6 Расчет наружного освещения</h2>
                    </div>
                    <div class="app__page-header_top-container-right">
                    <Link to="/dlxevo/7" ><ChevronRightIcon fontSize="large" /></Link>
