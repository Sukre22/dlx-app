...
export default class AppMenuPages7 extends Component {
        ...
        <>
            ...
            <div class="app__page-header_top">
                ...
                <div class="app__page-header_top-container">
                    ...
                    <Link to="/dlxevo/6" ><ChevronLeftIcon fontSize="large"/></Link>
                    </div>
                    <div class="app__page-header_top-container-title">
                        <h2 class='work'>7 Создание отчета</h2>
                    </div>
                    <div class="app__page-header_top-container-right">
                    <Link to="/dlxevo/8" ><ChevronRightIcon fontSize="large" /></Link>
                ...
                <div class="app__page-title_files">
                   ...
                   <div class="app__page-title_files-wrap">
                            ...
                            <p className="app__page-title_files-wrap-zip">Урок-7.zip</p>
                        </div>
