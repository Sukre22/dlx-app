...
export default class AppMenuPages45 extends Component {
        ...
        <>
            ...
            <div class="app__page-header_top">
                ...
                <div class="app__page-header_top-container">
                    ...
                    <Link to="/dlxevo/4.4" ><ChevronLeftIcon fontSize="large"/></Link>
                    </div>
                    ...
                    <Link to="/dlxevo/5.1" ><ChevronRightIcon fontSize="large" /></Link>
                ...
                <div className="app__page-title_video">
                    ...
                    src="https://www.youtube.com/embed/BIE2KiW4Wbo" title="YouTube video player" 
                ...
                <div class="app__page-title_files">
                   ...
                   <div class="app__page-title_files-wrap-icon"><a class="app__page-title_files-wrap-icon-a" href="https://disk.yandex.ru/d/5f-jJ0-we0lG-g" target="_blank"><CloudDownloadIcon/></a></div>

                 <p className="app__page-title_files-wrap-zip"><a href="https://disk.yandex.ru/d/5f-jJ0-we0lG-g" target="_blank">Урок-4.5.zip</a></p>
                    </div>
                ...
                <div class="app__page-title_files-task">
                    ...
                    <ul className="app__page-title_files-text">
                                ...
                                <li>Сделать цветовое оформление остальных помещений по своему вкусу.</li>
